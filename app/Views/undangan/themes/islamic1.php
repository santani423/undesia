    ...
    <section class="full header">
        <div class="container">
            ...
            <div class="col-md-12">
                ...
                <h1 class="text-secondary" data-aos="fade-up" data-aos-duration="1000"><?php if ($posisi_mempelai == 0) echo $nama_panggilan_pria . "<br>&<br> " . $nama_panggilan_wanita;
                                                                                        else echo $nama_panggilan_wanita . "<br>&<br>" . $nama_panggilan_pria; ?></h1>
            </div>
