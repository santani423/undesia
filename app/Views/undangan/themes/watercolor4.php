...
<body>
            ...
            <div class="col-md-6 col-sm-12 col-md-offset-3">
                <?php foreach ($rules->getResult() as $set) {
                    ...
                    <p>Selamat datang di undangan pernikahan Kami.
                        <br>Gunakan browser Chrome atau Safari agar website tampil sempurna. Scroll untuk melihat detail undangan.
                    </p>
                    <br>
        ...
        <div class="container">
            <div class="col-md-12" data-aos="fade-down" data-aos-delay="100">
                ...
                <h1 class="text-secondary">
                    <?php if ($posisi_mempelai == 0) echo $nama_panggilan_pria . " <span class='h5 my-3 font-weight-bold'><b>and</b></span> " . $nama_panggilan_wanita;
                    else echo $nama_panggilan_wanita . " <span class='h5 my-3 font-weight-bold'><b>and</b></span> " . $nama_panggilan_pria; ?></h1>
                <h5 class="text-blue mt-3 mb-3 d-inline-block">
                    ...
                    <div class="d-inline-block date-center"><?= date('D', strtotime($tgl_acara)) ?><br>
                        <b><?= date('d', strtotime($tgl_acara)) ?></b>
                    </div>
    ...
    <div style="height:50px;width:60px;position: absolute;bottom:0;z-index:-1;visibility: hidden;">
        <audio id="player" autoplay loop>
            <source src=<?php echo base_url() ?><?= $musiknya ?> type=audio/mp3>
        </audio>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center mb-3">
                    ...
                    <h5 class="font-bold text-center">Kirim Hadiah<br><small>Untuk <?php if ($posisi_mempelai == 0) echo $nama_panggilan_pria . " & " . $nama_panggilan_wanita;
                                                                                    else echo $nama_panggilan_wanita . " & " . $nama_panggilan_pria; ?></small></h5>
                </div>
                <?php
                $i = 1;
