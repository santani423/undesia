        ...
        <div class="container">
            <div class="col-md-12" data-aos="fade-down" data-aos-delay="100">
                ...
                <h1 class="text-secondary">
                    <?php if ($posisi_mempelai == 0) echo $nama_panggilan_pria . " <span class='d-block h5 font-weight-bold'>AND</span> " . $nama_panggilan_wanita;
                    else echo $nama_panggilan_wanita . " <span class='d-block h5 font-weight-bold'>AND</span> " . $nama_panggilan_pria; ?></h1>
