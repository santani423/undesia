    ...
    <section class="full header">
        <div class="container">
            <div class="col-md-12 top">
                ...
                <h1 class="text-secondary" data-aos="fade-up" data-aos-duration="1000"><?php if ($posisi_mempelai == 0) echo $nama_panggilan_pria . " <span>&</span> " . $nama_panggilan_wanita;
                                                                                        else echo $nama_panggilan_wanita . " <span>&</span> " . $nama_panggilan_pria; ?></h1>
            </div>
