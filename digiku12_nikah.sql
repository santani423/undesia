...
--
-- Host: localhost:3306
-- Generation Time: Aug 23, 2022 at 08:27 PM
...
(1, 'admin', '024a4caa088a274f184871009e90518a', 'kakmus12@gmail.com', 'Mustari', '2020-08-27 04:38:43');
...
(1, 1, 'demo', '54', 3, 1, '2022-03-01 14:01:31', '2022-08-19 21:31:28'),
...
(1, 'Silver', '30000', 30, 0, 0, 0, 0, 0),
(2, 'Gold', '50000', 30, 0, 0, 1, 1, 0),
(3, 'Diamond', '75000', 30, 1, 1, 1, 1, 1);
...
(20, 1, 'Tamu Undangan', '36.74.111.129', '2022-08-19 14:25:06', '2022-08-19 21:25:06'),
(21, 1, 'Tamu Undangan', '36.74.111.129', '2022-08-19 14:25:54', '2022-08-19 21:25:54'),
(22, 1, 'Tamu Undangan', '36.74.111.129', '2022-08-19 14:27:32', '2022-08-19 21:27:32'),
(23, 1, 'Tamu Undangan', '114.5.221.52', '2022-08-19 14:30:54', '2022-08-19 21:30:54'),
(24, 1, 'Tamu Undangan', '114.5.221.52', '2022-08-19 14:31:39', '2022-08-19 21:31:39'),
(25, 1, 'Tamu Undangan', '2001:448a:5020:d53c:8d19:1e36:d6fd:8d05', '2022-08-20 05:52:25', '2022-08-20 12:52:25');
...
CREATE TABLE `setting` (
  ...
  `wa_gateway` enum('nusagateway','starsender','onesender') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'nusagateway',
...
(1, 100000, 'bank.png', '2022-08-20 15:41:38', 2, 60, 'kakmus12@gmail.com', 'kakmus12@gmail.com', 'Maulana2107', '6285161016200', 'Hello Admin NikahKuy, Saya Mau bertanya.', 'Assalamu\'alaikum Warahmatullahi Wabarakatuh.\n\nDengan memohon Rahmat dan Ridho Allah SWT, Kami akan menyelenggarakan resepsi pernikahan Putra-Putri kami :', 'starsender', '2f6a625e06edf217a6a6527150f70c532e604770', 'Assalamualaikum Wr Wb.\nDengan segala kerendahan hati dan syukur atas Karunia Allah SWT.\nKami bermaksud mengundang Bapak/Ibu/Saudara(i) pada acara pernikahan kami.', 'Merupakan suatu kebahagiaan bagi Kami apabila Bapak/Ibu/Saudara(i) berkenan hadir untuk memberikan doa restu kepada kami.\nAtas kehadiran dan doa restunya kami ucapkan terimakasih.\n\nWassalamualaikum Wr Wb');
...
(1, 'manual', 'BRI', '618801012819536', 'Mustari', 'https://app.midtrans.com/snap/snap.js', '', '', 'true', '', '', '', '');
...
(1, '6285161016200', 'demo@gmail.com', 'Demo', '827ccb0eea8a706c4c34a16891f84e7b', '2007155', '2020-07-26 14:16:42', '', '2022-01-09 03:35:18'),
...
--
ALTER TABLE `acara`
  MODIFY `id_acara` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=203;
...
--
ALTER TABLE `slider_bukutamu`
  MODIFY `id_slider` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
